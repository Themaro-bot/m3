...
let handler = async (m, { conn }) => {
    ...
    if (user.lastngojek !== 0){
      if (user.lastngojek < 600000) throw m.reply(`Kamu masih kelelahan\nHarap tunggu ${timers} lagi`)
    }
    
     if (new Date - global.db.data.users[m.sender].lastngojek > 600000) {
...
global.db.data.users[m.sender].miko += rbrb4
