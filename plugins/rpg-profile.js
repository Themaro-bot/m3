...
let user = db.data.users[m.sender]
    ...
    try {
        pp = global.db.data.users[who].ppuser ? global.db.data.users[who].ppuser : await conn.profilePictureUrl(who, 'image').catch(_ => 'https://mycipongkor.com/wp-content/uploads/2022/05/Foto-profil-WA-kosong-senyum-min.jpg')
      } catch (e) {
...
*🌟 Premium:* ${premium ? "✅" :"❌"}
*⏰ PremiumTime:* 
${clockString(global.db.data.users[who].premiumTime - ((new Date() * 1) - global.db.data.users[who].premiumDate))}
