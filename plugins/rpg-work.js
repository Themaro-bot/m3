...
let handler = async (m, { conn, usedPrefix }) => { 
    try { 
        ...
        if (global.db.data.users[m.sender].health > 79) {
            if (new Date - global.db.data.users[m.sender].lastadventure > 300000 || global.db.data.users[m.sender].lastadventure == 0) {
...
`.trim()
            ...
            global.db.data.users[m.sender].miko += uang * 1
            ...
            global.db.data.users[m.sender].wood += kayu * 1
