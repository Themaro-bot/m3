...
let time = global.db.data.users[m.sender].lastjb + 600000
...
global.db.data.users[m.sender].lastkerja = new Date * 1
	m.reply(`Kamu baru saja selesai ${rumah} 🔨\nDan mendapatkan MIKO senilai *Rp ${duitk} 💹*`)
break
default:
