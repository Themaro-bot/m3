...
let nomors = m.sender
  ...
  if (new Date - global.db.data.users[m.sender].lastrob > 3600000 || global.db.data.users[m.sender].lastrob == 0){
  if (100000 > users[who].miko) throw 'ᴛᴀʀɢᴇᴛ ɢᴀᴀᴅᴀ 💰ᴜᴀɴɢ ʙᴏᴅᴏʜ, ᴋɪꜱᴍɪɴ ᴅɪᴀ'
  users[who].miko -= dapat * 1
  users[m.sender].miko += dapat * 1
