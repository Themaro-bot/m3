                ...
                if (global.db.data.users[m.sender].iron > 4) {
                    if (global.db.data.users[m.sender].wood > 499) {
                        if (global.db.data.users[m.sender].string > 9) {
                            ...
                            global.db.data.users[m.sender].wood -= kayun * 1
...
`.trim()
        ...
        case 'weapon':
            ...
            let kayuw = global.db.data.users[m.sender].wood
                    ...
                    if (global.db.data.users[m.sender].wood > 999) {
                        if (global.db.data.users[m.sender].string > 9) {
                            if (global.db.data.users[m.sender].sword > 9) {
                                ...
                                global.db.data.users[m.sender].wood -= kayunnw * 1
...
`.trim()
            ...
            break
        case 'pancingan':
            let kayuh = global.db.data.users[m.sender].wood
