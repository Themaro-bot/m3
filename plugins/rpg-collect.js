let handler = async (m, { conn }) => {
    ...
    if (new Date - global.db.data.users[m.sender].lastclaim > 43200000 || global.db.data.users[m.sender].lastclaim == 0) {
        conn.reply(m.chat, `Kamu sudah mengclaim dan mendapatkan *1000* 💵MIKO dan *1* 🥤potion`, m)
        user.miko += 1000
        user.potion += 1
